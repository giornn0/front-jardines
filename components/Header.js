...
export const Header = ()=>{
  ...
  <nav className="w-full sticky top-0 flex flex-row md:justify-center justify-between items-center p-4 bg-gradient-color-header border-rose-300">
      <div className="basis-1/4 flex justify-center item-center">
        <Image src={logo} alt="logo" className="h-10 w-25 cursor-pointer" height="75" width="100" fixed />
      </div>
      ...
      <div className=" basis-1/4 flex justify-center item-center">
        ...
        <button className="bg-[#000] py-2 px-7 mx-4 rounded-lg cursor-pointer hover:bg-[black]">
          Registrar
        </button>
        </div>
      </div>
